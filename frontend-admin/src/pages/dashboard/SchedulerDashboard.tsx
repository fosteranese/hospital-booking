        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {appointments.map(a => (
                  <tr key={a.id} onClick={() => setSelectedAppointmentId(a.id)} className="group cursor-pointer transition-colors hover:bg-slate-50 border-b border-slate-50 last:border-0">
