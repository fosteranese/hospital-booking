...
export function PatientSearchPage() {
  ...
  const selectPatient = async (p: Patient) => {
    ...
    try {
      ...
      setHistory([...upcoming.map(a => ({ ...a, patient_id: '', patient_name: '', patient_email: '', patient_phone: null, attended: null, minutes_late: null, arrival_time: null, cancellation_reason: '', has_conflict: false })), ...past]);
    } catch (e: any) {
      setError(e.message);
    } finally {
